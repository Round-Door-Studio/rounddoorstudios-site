...
export default defineConfig({
  ...
  // Lower parallelism in CI: GitHub-hosted runners share limited CPU between
  // `next start` and every worker, and higher worker counts were compounding
  // the cache-cold-concurrency race (see cache-concurrency-caveat memory) plus
  // causing unrelated timing-sensitive tests (login/logout) to flake under load.
